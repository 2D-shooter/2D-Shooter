...
//////////        // Inside your WeaponController.cs, update the DoShoot method:
//////////        private void DoShoot()
//////////        {
//////////            float delay = Mathf.Max(activeWeaponData.fireRate, 0.1f);
//////////            nextFireTime = Time.time + delay;
...
//////////            GameObject bulletObj = Instantiate(activeWeaponData.projectilePrefab, currentFirePoint.position, currentFirePoint.rotation);
//////////            if (bulletObj.TryGetComponent<Projectile>(out Projectile projectile))
//////////            {
//////////                // PASS THE DAMAGE FROM WEAPON DATA (11 or 16)
...
////////using System.Collections.Generic;
////////using UnityEngine.InputSystem;
////////using TopDown.Core; // Added for Health script access
...
////////        [SerializeField] private PunchEffect punchVisualEffect;
////////        [SerializeField] private Transform fistPoint;
////////        [SerializeField] private float punchDamage = 25f; // New damage value
...
////////            if (bullet.TryGetComponent<Projectile>(out Projectile projectile))
////////            {
////////                projectile.SetDamage(activeWeaponData.damage); // Pass weapon damage
////////                projectile.ShootBullet(currentFirePoint);
////////            }
...
////////            foreach (var obj in hitObjects)
////////            {
////////                // Updated to find the Health script
...
//////namespace TopDown.Shooting
//////{
//////    // The Enum must be defined here so the script knows what "Fists" is
//////    public enum WeaponType { Fists, Pistol, AssaultRifle }
...
//////            foreach (var obj in hitObjects)
//////            {
//////                // Logic check: Looks for the new Health script specifically
//////                if (obj.TryGetComponent<Health>(out var health))
//////                {
//////                    health.TakeDamage(punchDamage);
//////                }
...
//        // ADDED THIS BACK: Fixes the error in AmmoPickup.cs
//        public void AddAmmo(WeaponType type, int amount)
//        {
//            if (totalAmmoPool.ContainsKey(type))
//            {
...
//                // If we are currently holding this weapon, update the UI value immediately
